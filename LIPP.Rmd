...
We will be working with data from Dr. Nicole Rosen's LIPP corpus which she has been building over the past several years. We will focus on data collected in interviews with Winnipeg residents who are either migrants from the Philippines, or who have Filipino ancestry.

---

## Loading the data

First, we will make sure that some R packages are loaded which we will need later. The `dplyr` package may give you some warnings which you don't need to worry about.
